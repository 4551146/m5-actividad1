package cl.kibernum.actividad1;
...
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "cl.kibernum.actividad1.steps") // Indicar donde estan los steps definitions
